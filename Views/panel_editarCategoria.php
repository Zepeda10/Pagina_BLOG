...
<body>
    ...
    <div class="content">
        ...
        <div class="inter">
            ...
            <form action="../../login/updateCategoria" method="POST" enctype="multipart/form-data" id="form">
                <input type="hidden" name="id" id="id"  value="<?php echo $data['id']; ?>">
                <label for="titulo">Categoría</label>
                <input type="text" name="categoria" id="categoria" placeholder="Categoría" value="<?php echo $data['categoria'];?>">
