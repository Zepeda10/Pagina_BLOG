...
<body>
    ...
    <div class="content">
        ...
        <div class="inter">
            ...
            <form action="../../login/update" method="POST" enctype="multipart/form-data" id="form">
                <input type="hidden" name="fecha" id="fecha" value="<?php echo $fecha; ?>">
                <input type="hidden" name="id" id="id" value="<?php echo $data['id']; ?>">
                <label for="titulo">Título</label>
                <input type="text" name="titulo" id="titulo" placeholder="Título" value="<?php echo $data['titulo']; ?>">
                <label for="texto">Texto</label>
                <textarea name="texto" id="texto" cols="30" rows="10" placeholder="Texto"> <?php echo $data['texto']; ?></textarea>
