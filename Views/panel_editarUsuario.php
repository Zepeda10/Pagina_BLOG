...
<body>
    ...
    <div class="content">
        ...
        <div class="inter">
            ...
            <form action="../../usuarios/update" method="POST" enctype="multipart/form-data" id="form">
                <input type="hidden" name="id" id="id" value="<?php echo $data['id']; ?>">
                <label for="titulo">Usuario</label>
                <input type="text" name="usuario" id="usuario" placeholder="Usuario" value="<?php echo $data['usuario']; ?>">
                <label for="texto">Contraseña</label>
                <input name="pass" id="pass" type="text" placeholder="Contraseña" value="<?php echo $data['pass']; ?>">
